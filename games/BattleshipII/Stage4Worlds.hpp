...
#ifndef __BATTLESHIPII_STAGE4WORLDS__
#define __BATTLESHIPII_STAGE4WORLDS__
...
namespace BattleshipII
{
	...
	class Stage4World : public BATTLESHIP::World
	{
		public:
		Stage4World (const QGAMES::Scenes& scns, 
				const QGAMES::WorldProperties& prps = QGAMES::WorldProperties ())
			: BATTLESHIP::World (__BATTLESHIPII_STAGE4WORLDID__, scns, prps)
							{ }
