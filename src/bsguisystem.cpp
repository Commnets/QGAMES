...
// ---
void BATTLESHIP::GUISystem::drawOn (QGAMES::Screen* s, const QGAMES::Position& p)
{
...
// ---
BATTLESHIP::WhenFocusDecorator::WhenFocusDecorator ()
...
// ---
void BATTLESHIP::ControlWidget::processEvent (const QGAMES::Event& e)
{
	if (e.code () == __QGAMES_WIDGETGETFOCUSEVENT__)
		((QGAMES::Widget*) e.data ()) -> setDecorator (new BATTLESHIP::WhenFocusDecorator ());
	else
