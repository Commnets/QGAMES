...
// ---
void DRAGONWIND::GUISystem::drawOn (QGAMES::Screen* s, const QGAMES::Position& p)
{
...
// ---
DRAGONWIND::WhenFocusDecorator::WhenFocusDecorator ()
...
// ---
void DRAGONWIND::ControlWidget::processEvent (const QGAMES::Event& e)
{
	if (e.code () == __QGAMES_WIDGETGETFOCUSEVENT__)
		((QGAMES::Widget*) e.data ()) -> setDecorator (new DRAGONWIND::WhenFocusDecorator ());
	else
