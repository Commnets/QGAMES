...
#define MyAppName "AticAtac"
#define MyAppExeName "AticAtac.exe"
#define MyProductName "Community Networks Atic Atac"
#define MyProductInfo "Community Networks Atic Atac"
#include "..\Commons\Commons.iss"

[Setup]
AppId={{EA46A8CB-FC6E-49B8-B3E5-F72E5D89B1C0}
SetupIconFile=Knight.ico
UninstallDisplayIcon={app}\Knight.ico

[Files]
Source: "resources.icf"; DestDir: "{app}"; Flags: ignoreversion
Source: "AticAtac Map.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "AticAtac.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "conf.xml"; DestDir: "{app}"; Flags: ignoreversion; AfterInstall: configureConf
Source: "Knight.ico"; DestDir: "{app}"; Flags: ignoreversion
