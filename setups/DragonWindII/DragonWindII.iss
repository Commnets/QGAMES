...
#define MyAppName "DragonWindII"
#define MyAppExeName "DragonWindII.exe"
#define MyProductName "Community Networks DragonWind II"
#define MyProductInfo "Community Networks DragonWind II"
#include "..\Commons\Commons.iss"

[Setup]                                            
AppId={{A4D290F9-489A-45C8-9DFD-DB1E0A0F3B11}
SetupIconFile=DragonIcon.ico
UninstallDisplayIcon={app}\DragonIcon.ico
...
Source: "resources6.icf"; DestDir: "{app}"; Flags: ignoreversion
Source: "DragonWindII.exe"; DestDir: "{app}"; Flags: ignoreversion
