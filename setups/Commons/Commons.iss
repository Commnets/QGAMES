...
VersionInfoCopyright=2009 - 2020 Community Networks S.L.
...
Source: "..\..\commonlibs\fmod.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\fmodL.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libFLAC-8.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libfreetype-6.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libharfbuzz-0.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libjpeg-9.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libmodplug-1.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libmpg123-0.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libogg-0.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libopus-0.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libopusfile-0.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libpng16-16.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libtiff-5.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libvorbis-0.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libvorbisfile-3.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\libwebp-7.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\SDL2.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\SDL2_gfx.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\SDL2_image.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\SDL2_mixer.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\SDL2_ttf.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\commonlibs\zlib1.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Filename: "{app}\vcredist_x86.exe"; WorkingDir: "{app}"; Flags: postinstall skipifsilent nowait; Description: "VS2022 C++ Redistribuible Package"
